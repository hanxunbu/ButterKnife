...
public class HttpClientUtil {
    ...
    public static void getResult(URL targetURL, HttpClientListener listener){
        ...
        try {
            ...
            conn.setConnectTimeout(8000);//设施连接超时
    ...
    /**给图片控件设置图片*/
    public static void setIamge(String iamgeUrl, final ImageView targetView /*listenter,图片加载成功之后的回调*/){
    ...
    public static void getResult(String url , final Handler handler){
       ...
       call.enqueue(new Callback() {
           ...
           public void onResponse(Call call, Response response) throws IOException {
               ...
               //InputStream is = response.body().byteStream();//支持大文件的的下载
                //进行json解析
                System.out.println(result);
                Gson gson = new Gson();
                ImagetoGank data = gson.fromJson(result,ImagetoGank.class);
                Message msg = handler.obtainMessage();
                msg.what = App.IMAGE_LOAG;
                msg.obj = data;
